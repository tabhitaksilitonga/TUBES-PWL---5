    ...
    <form action="{{ route('jobs.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow p-8">
        ...
        <div class="mb-6">
            ...
            <textarea name="description" required rows="8" 
                      ...
                      placeholder="Describe the role, requirements, benefits, speciality, and how to apply. Example: Speciality: UI, UX, Product Design.">{{ old('description') }}</textarea>
        ...
        <div class="mb-6">
            ...
            <p class="text-xs text-gray-500 mt-1">If provided, applicants will be redirected here.</p>
